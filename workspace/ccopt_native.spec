...
#  Generated on:      Wed Jun 17 15:56:23 2026
#  Design:            DatapathPipelined
...
#   clk (period 10.000ns) in timing_config func_mode([../constraints/RV32.sdc])
create_ccopt_clock_tree -name clk -source clk -no_skew_group
set_ccopt_property target_max_trans_sdc -delay_corner typical_delay_corner -early -clock_tree clk 0.200
set_ccopt_property target_max_trans_sdc -delay_corner typical_delay_corner -late -clock_tree clk 0.200
...
# Skew group to balance non generated clock:clk in timing_config:func_mode (sdc ../constraints/RV32.sdc)
...
set_ccopt_property extracted_from_constraint_mode_names -skew_group clk/func_mode {func_mode  }
set_ccopt_property extracted_from_delay_corners -skew_group clk/func_mode typical_delay_corner
