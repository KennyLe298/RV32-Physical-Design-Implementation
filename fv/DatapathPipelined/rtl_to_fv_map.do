...
# Generated on: Sat Jun 13 16:43:56 +07 2026 (Sat Jun 13 09:43:56 UTC 2026)
...
set logfile fv/DatapathPipelined/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/DatapathPipelined -revised fv_map
...
read_library -liberty -both \
    /data/cc04group1/2352346/work/synthesis_env/RISCV32/workspace/../LIB/typical.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../RTL/DatapathPipelined.v ../RTL/cla.v ../RTL/DividerUnsignedPipelined.v ../RTL/divu_1iter.v
elaborate_design -golden -root {DatapathPipelined} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/DatapathPipelined/fv_map.v.gz
elaborate_design -revised -root {DatapathPipelined}
...
#add_name_alias fv/DatapathPipelined/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.DatapathPipelined.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.DatapathPipelined.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.DatapathPipelined.rtl.fv_map.rpt
